...
- **Achado do log do dia**: a aba `Dispersão de km` estava FILTRADA (26 linhas contra 998), o porteiro recusou e o banco manteve a última boa. O **Saude Robot** está falhando desde 23/09 à tarde com `PGRST102: All object keys must match` ao gravar `saude_base` (bug do robô, pendente).
