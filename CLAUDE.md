...
- **Teste de mecânica** (`scripts/gviz-banco-teste.mjs`): abre os 37 painéis no Chromium com o **Google bloqueado** e o banco dublado, e reprova se qualquer pedido escapar para o `docs.google`.
