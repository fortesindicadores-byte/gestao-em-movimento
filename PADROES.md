...
| **Conta do Ginfo é UMA** | os três workflows (`ginfo-robot`, `elite-robot`, `conf-detalhe`) compartilham `concurrency: group: ginfo-conta` (10/09/2026): a segunda sessão derruba a primeira e o embed rende sem slicer | | | |
...
- **Elite Robot de ago/26:** 7 indicadores faltando na primeira rodada por colisão de sessão no Ginfo (corrigida com o grupo `ginfo-conta`); segunda rodada em curso.
